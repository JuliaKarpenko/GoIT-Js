...
class Hamburger {
     ...
     * */
    addTopping(topping) {
        return !this._toppings.includes(topping) ? this._toppings.push(topping) : this._toppings;
    }
    ...
    removeTopping(topping) {
        if (this._toppings.includes(topping)) {
            let indexTopping = this._toppings.indexOf(topping);
    ...
    get calculateCalories() {
        ...
        if (this._toppings.length > 0) {
            for(let x of this._toppings){
                sum = sum + Hamburger.TOPPINGS[x].calories;
                }
                return sum + calories;
